...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background font-sans">
      ...
      >
        <h1 className="text-3xl font-extrabold mb-2 text-center text-primary">Criar conta</h1>
        <p className="text-muted text-center text-sm mb-2">Preencha os campos para se cadastrar</p>
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="confirmPassword" className="text-sm font-medium text-muted">Confirmar senha</label>
          <input
            id="confirmPassword"
            type="password"
